                    ...
                    if (d.length >= set.minimumLength)
                    {
                         ...
                         if (c != 0)
                         {
                              ...
                              for (var i = 0; i < found.length; i++)
                              {
                                   ...
                                   {                                   
                                        out += '<div><a href="' + found[i].url + '"' + tipue_search_w + '>' +  found[i].title + '</a></div>';
                                        ...
                                        if (set.showURL)
                                        {
                                             ...
                                             out += '<div><a href="' + found[i].url + '"' + tipue_search_w + '>' + s_u + '</a></div>';
                                        }
                              ...
                              if (c > set.show)
                              {
                                   ...
                                   out += '<div><ul class="pagination pagination-lg">';
                                   if (start > 0)
                                   {
